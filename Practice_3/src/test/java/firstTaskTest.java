...
public class firstTaskTest {
    ...
    @DataProvider
    public static Object[][] data1() {  // Card number check. Invalid data.
        return new Object[][] {
    ...
    @DataProvider
    public static Object[][] data2() {  // Card holder name check. Invalid data.
        return new Object[][] {
                {"4000000000000002",  "JohnDoe", "02", "2030", "123"},
                {"4000000000000002",  "123445", "02", "2030", "123"},
    ...
    public void finalPageTesting(String cardNum, String cardHolder, String cardMonth, String cardYear, String cardCvc) {
        driver.get(baseUrl);
    ...
    @Test
    @UseDataProvider("data2")  // Invalid card numbers
